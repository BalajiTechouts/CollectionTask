...
public class SlotsAtSportsComplex {
	...
	public static void main(String[] args) {
		...
		SlotsAtSportsComplex sp=new SlotsAtSportsComplex();
		sp.listofsports();
   ...
   public void listofsports() {
		...
		Map<Integer,String>listofsports=new HashMap<>();
		listofsports.put(1,"Badminton court");
		listofsports.put(2, "Football");
		listofsports.put(3, "Box cricket");
		System.out.println("Serial No"+"     "+"Name Of The Sport");
		System.out.println("   ");
		for (Map.Entry<Integer, String> list : listofsports.entrySet()) {
